...
Q.load(['clouds.png', 'game-tiles.png', 'game2.json', 'player-sprite.png', 'sheepfold-sprite.png', 'wolf-sprite.png'], function () {
...
Q.scene('game', function (stage) {
	...
	var tiles = new Q.TileLayer({
		dataAsset: 'game2.json', // Nom du fichier tileset
