...
Q.load(['Halloween-Night.png', 'game-tiles2.png', 'game4.json', 'player-sprite2.png', 'sheepfold-sprite.png', 'wolf-sprite2.png'], function () {
...
Q.scene('game', function (stage) {
	...
	stage.insert(new Q.Repeater({ asset: 'Halloween-Night.png', speedY: 0.5 }));
