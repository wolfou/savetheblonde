...
Q.load(['Enfer2.png', 'game-tiles2.png', 'game4.json', 'player-sprite2.png', 'sheepfold-sprite.png', 'zombi-spirite.png'], function () {
...
Q.scene('game', function (stage) {
	...
	stage.insert(new Q.Repeater({ asset: 'Enfer2.png', speedY: 0.5 }));
